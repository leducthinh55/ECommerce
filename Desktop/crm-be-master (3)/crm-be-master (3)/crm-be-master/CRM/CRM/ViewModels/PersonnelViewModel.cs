...
namespace CRM.ViewModels
{
    public class PersonnelVM
    {
        ...
        public int TotalDomesticEmployeeInsideOrther { get; set; }
    ...
    public class PersonnelUM : PersonnelVM
    {
